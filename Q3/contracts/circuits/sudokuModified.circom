...
template sudoku() {
    ...
    component rangePuzzle[9][9];
    component rangeSolution[9][9];
    
    for (var i=0; i<9; i++) {
        for (var j=0; j<9; j++) {
            rangePuzzle[i][j] = RangeProof(32);
            rangePuzzle[i][j].in <== puzzle[i][j];
            rangePuzzle[i][j].range[0] <== 0;
            rangePuzzle[i][j].range[1] <== 9;
            rangePuzzle[i][j].out === 2;
            rangeSolution[i][j] = RangeProof(32);
            rangeSolution[i][j].in <== solution[i][j];
            rangeSolution[i][j].range[0] <== 0;
            rangeSolution[i][j].range[1] <== 9;
            rangeSolution[i][j].out === 2;
